...
combo_t key_combos[] = {
    ...
    COMBO(qutebrowser_back, LSFT(KC_J)),
    COMBO(qutebrowser_forward, LSFT(KC_K)),
    COMBO(qutebrowser_history_back, LSFT(KC_H)),
    COMBO(qutebrowser_history_forward, LSFT(KC_L)),
